    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_type', models.CharField(blank=True, choices=[('google', 'Google Review'), ('trustpilot', 'TrustPilot')], default='', help_text='Определяется автоматически на основе Leads Won', max_length=20)),
